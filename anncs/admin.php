...
<html>
	...
	<body>
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-link">
						<li><a href="http://localhost/admi_info.php">admin <span class="sr-only">(current)</span></a></li>
					</ul>
					<ul class="nav navbar-nav navbar-link">
		...
		<div class="container announce-wrapper">
			<a href="http://localhost/anncs/edit.php?anncs_id=<?php echo $anncs_id; ?>"><button class="btn btn-default btn-new" >修改公告</button></a>
			<a href="http://localhost/anncs/delete_act.php?anncs_id=<?php echo $anncs_id; ?>" onclick="return confirm('是否確認刪除此公告');"><button class="btn btn-default btn-remove" >刪除公告</button></a>
			<?php
