...
//基本上使用session儲存驗證碼
 ...
 for( $i=0; $i<$num_max; $i++ )
 {
      ...
      //imagettftext( $im ,12 ,0 ,$strx ,$strpos ,$black , "xxxx.ttf" ,substr($num,$i,1) );
      $size = 14;//字体大小
      //imagettftext($im, $size, 0 ,$strx ,$strpos ,  $font ,substr($num,$i,1));//生成验证字符窜
      //imagettftext($im, $size, 0, 3, 3, $black, $font, substr($num,$i,1));
