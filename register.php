...
<html>
	...
	<body>
		<form name="form" method="post" action="http://localhost/register_add.php">
			...
			<form action="auth/register.php" method="POST">
				<div class="row">
					...
					<div class="col-md-3 col-md-offset-3">
						...
						<input class="btn btn-default btn-remove" type="button" value="取消" onclick="location.href='http://localhost/index.php'">
