...
<html>
	...
	<body>
		...
		<div class="container announce-wrapper">
			<h3 class="title">會員資料<!--<a href="http://localhost/info/edit.php"><button class="btn btn-default btn-remove">修改會員資料</button></a>--></h3>
			...
			<div class="row">
				<table class="table">
	                ...
	                <!--<td class="td-date"><?php echo "id"; ?></td>
	                <td class="td-date"><?php echo "Student_ID"; ?></td>
	                <td class="td-date"><?php echo "Name"; ?></td>
	                <td class="td-date"><?php echo "Email"; ?></td>
	                <td class="td-date"><?php echo "Identity"; ?></td>-->
					<?php 
	                ...
	                <!--<td scope="row"><?php echo $person->id; ?></td>
	                <td class="td-date"><?php echo $person->account; ?></td>
	                <td class="td-date"><?php echo $person->user_name; ?></td>
	                <td class="td-date"><?php echo $person->mail; ?></td>
	                <td class="td-date"><?php echo $person->identity; ?></td>-->
